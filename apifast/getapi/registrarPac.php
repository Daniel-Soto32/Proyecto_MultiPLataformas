            ...
            <div class="row flex-nowrap">
                ...
                <form action="" method="post">        
                    <div class="row" style="height: 100px;">
                        <div class = "col-4" align="center"> 
                            <div class="form-group" style="padding-bottom: 30px; padding-right: 20px ;width: 300px;" >
                                <label style="padding-bottom: 10px; float: left;" for="Name">Nombre</label>
                    ...
                    <div class="row" style="height: 100px;">
                        ...
                        <div class = "col-4" align="center"> 
                            <div class="form-group" style="padding-bottom: 30px; padding-right: 20px ;width: 300px;" >
                                <label style="padding-bottom: 10px; float: left;" for="direccion">Edad</label>
                                <input style="border-radius: 10px;" name="edad" type="direccion" class="form-control" id="direccion" placeholder="Ingrese su dirección">
                            </div>
                        </div>
                        <div class = "col-4" align="center"> 
                            <div class="form-group" style="padding-bottom: 30px; padding-right: 20px ;width: 300px;" >
                    ...
                    <div class="row" style="height: 100px;">
                        <div class = "col-4" align="center"> 
                            <div class="form-group" style="padding-bottom: 30px; padding-right: 20px ;width: 300px;" >
                                <label style="padding-bottom: 10px; float: left;" for="cedula">Alergias</label>
                                <input style="border-radius: 10px;" name="alergias" type="text" class="form-control" id="cedula" placeholder="Ingrese su cédula médica">
                            </div>
                       
                        </div>
                        <div class = "col-4" align="center"> 
                            <div class="form-group" style="padding-bottom: 30px; padding-right: 20px ;width: 300px;" >
                                <label style="padding-bottom: 10px; float: left;" for="ramaMedica">Antecedentes médicas</label>
                                <input style="border-radius: 10px;" name="antecedentes" type="text" class="form-control" id="ramaMedica" placeholder="Ingrese su rama médica">
                            </div>
                        </div>
                        <div class = "col-4" align="center"> 
                            <div class="form-group" style="padding-bottom: 30px; padding-right: 20px ;width: 300px;" >
                                <label style="padding-bottom: 10px; float: left;" for="direccion">ID del doctor</label>
                                <input style="border-radius: 10px;" name="idDoc" type="number" class="form-control" id="direccion" placeholder="Ingrese su dirección">
                            </div>
                        </div>
                    </div>
                    <div class="row" style="height: 100px;">
                        <div class = "col-4" align="center"> 
                            <div class="form-group" style="padding-bottom: 30px; padding-right: 20px ;width: 300px;" >
                                <label style="padding-bottom: 10px; float: left;" for="usuario">Usuario</label>
                        ...
                        <div class = "col-4" align="center"> 
                            <div class="form-group" style="padding-bottom: 30px; padding-right: 20px ;width: 300px;" >
                                ...
                                <input style="border-radius: 10px;" name="pass1" type="password" class="form-control" id="contraseña" placeholder="Ingrese su contraseña">
                            </div>
                        </div>
                        <div class = "col-4" align="center"> 
                            <div class="form-group" style="padding-bottom: 30px; padding-right: 20px ;width: 300px;" >
